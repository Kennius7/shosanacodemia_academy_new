        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <div className="space-y-4 text-slate-400 leading-relaxed">
              <p>
                Shosanacodemia was founded on a single conviction: technical talent is everywhere in
                Africa, but world-class, structured training is scarce. We exist to close that gap.
              </p>
              <p>
                Our curriculum is built directly with hiring engineers — people who interview
                candidates, review pull requests, and architect systems at scale. Every module
                teaches what actually matters on the job, not just what looks good in a syllabus.
              </p>
              <p>
                We measure our success by one metric: did our graduates get hired, and did they
                thrive? With a 95% employment rate and alumni at Flutterwave, Paystack, Andela, and
                beyond, we believe the answer speaks for itself.
              </p>
            </div>

            {/* Values */}
            <div className="mt-8 flex flex-wrap gap-3">
              {['Accountability', 'Real-world Skills', 'Community', 'Excellence'].map((v) => (
                <span
                  key={v}
          ...
          <div className="relative">
            <div className="aspect-[4/3] rounded-2xl overflow-hidden bg-gradient-to-br from-cyan-900/30 via-blue-900/30 to-purple-900/30 border border-slate-800 flex flex-col items-center justify-center gap-4">
              ...
              <span className="absolute bottom-4 text-sm font-medium text-slate-400">Our Team</span>
            </div>

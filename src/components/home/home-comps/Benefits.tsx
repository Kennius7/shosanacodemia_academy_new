    ...
    "🛠️": (
      ...
      >
        <path
          ...
          strokeWidth={1.5}
          d="M10.343 3.94c.09.542-.056 1.096-.386 1.527L7.5 9H5a2 2 0 00-2 2v2a2 2 0 002 2h2.5l2.457 3.533c.33.431.476.985.386 1.527C10.15 21.04 9.193 22 8 22H7a7 7 0 01-7-7v-2a7 7 0 017-7h1c1.193 0 2.15.96 2.343 1.94zM14 7l6 10M20 7l-6 10"
        />
      </svg>
    ),
    "🚀": (
      ...
      >
        <path
          ...
          strokeLinejoin="round"
          strokeWidth={1.5}
          d="M15.59 14.37a6 6 0 01-5.84 7.38v-4.8m5.84-2.58a14.98 14.98 0 006.16-12.12A14.98 14.98 0 009.631 8.41m5.96 5.96a14.926 14.926 0 01-5.841 2.58m-.119-8.54a6 6 0 00-7.381 5.84h4.8m2.581-5.84a14.927 14.927 0 00-2.58 5.84m2.699 2.7c-.103.021-.207.04-.311.058a15.09 15.09 0 01-2.448-2.448 14.9 14.9 0 01.058-.311m-2.638 2.698a6 6 0 01-1.037-5.433"
        />
      </svg>
    ),
  };
